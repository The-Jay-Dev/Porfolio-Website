  ...
  return (
    <div className="flex flex-col justify-center items-center h-auto w-screen">
      <Section className="mt-24 relative flex w-full flex-col justify-center items-center">
        <div className="absolute inset-0 h-full bg-linear-to-b from-[#1a1a1a]/80 to-[#3b3b3b]/80 z-1 overflow-hidden" />

        <ReactPlayer
          id="bgVideo"
          className="z-0 absolute top-0 left-0 w-full h-full object-cover react-player"
          src="/RebirthDemo.mp4"
          playsInline={true}
          muted={true}
          loop={true}
