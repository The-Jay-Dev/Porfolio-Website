  ...
  return (
    <div className="flex flex-col justify-center items-center h-auto w-screen">
      <Section className="relative flex w-full justify-center ">
        ...
        <div className=" mx-6  my-10 flex flex-col sm:flex-col lg:flex-row gap-6 sm:gap-6 xl:gap-12 items-center justify-center w-screen text-black/80">
          <div className="relative z-10 flex flex-col gap-6 items-center justify-center">
            <h1 className="w-full md:h1 text-center sm:text-center md:w-[20ch] md:text-6xl! lg:text-4xl! xl:text-6xl!  xl:text-center leading-16 lg:leading-normsl mb-6">
