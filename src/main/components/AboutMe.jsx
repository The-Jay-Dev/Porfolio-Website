...
const MemoryStates = () => {
  return (
    <Section
      id="aboutMe"
      className="relative flex justify-center h-screen items-center w-screen overflow-hidden"
    >
      <BioWindow />
      ...
      <div className="h-screen w-full flex flex-col justify-center items-center gap-6 ">
        ...
        >
          <p className="text-center sm:text-center xl:text-start font-primary italic md:!text-[1.3rem] lg:!text-[1.5rem] xl:!text-[1.2rem] mt-7  text-white/90 text-[100%] text-pretty w-[30ch] sm:w-[40ch] lg:w-[50ch] xl:w-[60ch] font-light ">
            ...
            creativity with clean code. I specialize in C++ and Qt development,
            building everything from engaging video games to innovative desktop
            apps. Recently, I've been developing{" "}
            <a
              href="/projectRebirth"
