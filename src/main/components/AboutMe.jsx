          ...
          <div className=" w-screen flex sm:flex-col md:flex-row justify-center items-center lg:gap-6 sm:gap-24 mx-6 ">
            <div className="h-screen flex flex-col justify-center items-center w-1/2 gap-6 ">
              ...
              <motion.div
                ...
                viewport={{ once: true, amount: 0 }}
              >
                <p className="sm:text-center xl:text-start font-primary italic lg:!text-[1.5rem] xl:!text-[1.2rem] mt-7  text-white/90 text-[90%] text-pretty sm:w-[40ch] lg:w-[50ch] xl:w-[60ch] font-light ">
