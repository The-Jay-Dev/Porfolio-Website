  ...
  return (
    ...
    >
      <a
        ...
        className="text-sm main-cta-btn border-white border-2 ease-out  hover:scale-[105%] hover:shadow-[0_0_20px_#7c3fff] py-4 px-6 inline-block relative  hover:bg-white hover:!text-home-accent-primary transition z-3 "
      >
        {btnText}
      </a>
    </button>
